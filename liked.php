...
<body>
    <?php if (isset($_SESSION["uid"])) { ?>
        ...
        <div class="forcss">
            <div class="listsong">
                <h1>List of Songs at Liked by <?php echo $_SESSION["uname"]; ?></h1>
                <div class="songitemcontainer">
                    <?php
                    $usrid = $_SESSION["uid"];
                    $sql = "SELECT * FROM `songs`,`likedsongs` WHERE `songs`.`id`=`likedsongs`.`songid` AND `likedsongs`.`userid` = '$usrid'";
            ...
            <div class="songitem">
                ...
                <a   href="./_disliked.php?songid=' . $row["songid"] . '">
                <img src="./icons/dislike.svg" style="width:30px;" />
                </a>
            </div>
            ';
                                $idx++;
